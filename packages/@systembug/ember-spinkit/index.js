...
module.exports = {
  ...
  included: function (app) {
    ...
    if (fs.existsSync(cssPath)) {
      ...
      console.warn(
        chalk.yellow(
          "You have installed ember-spinkit but you didn't run 'ember generate spinkit-<name of spinner>' yet. See https://github.com/pogopaule/ember-cli-spinkit for more information."
        )
      );
    }
  },
